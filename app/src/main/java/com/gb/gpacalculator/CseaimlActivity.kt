...
import com.gb.gpacalculator.databinding.ActivityCseaimlBinding
import com.google.android.material.dialog.MaterialAlertDialogBuilder

class CseaimlActivity : AppCompatActivity() {

    private lateinit var binding: ActivityCseaimlBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCseaimlBinding.inflate(layoutInflater)
    ...
    private fun solve() {
        ...
        val g3 = binding.editTextML.text?.toString()
